...
--
-- Inang: 127.0.0.1
-- Waktu pembuatan: 17 Des 2015 pada 03.06
-- Versi Server: 5.6.11
-- Versi PHP: 5.5.3
...
-- Basis data: `latedit`
--
CREATE DATABASE IF NOT EXISTS `latedit` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `latedit`;
...
--
-- Struktur dari tabel `histori_total_pasien_tahunan`
--
...
CREATE TABLE IF NOT EXISTS `histori_total_pasien_tahunan` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `tahun_id_2` (`tahun_id`,`puskesmas_id`,`bulan_id`),
  KEY `tahun_id` (`tahun_id`),
  KEY `puskesmas_id` (`puskesmas_id`),
  KEY `bulan_id` (`bulan_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=157 ;

--
-- Dumping data untuk tabel `histori_total_pasien_tahunan`
--
...
--
-- Struktur untuk view `v_histori_total_pasien_tahunan`
--
